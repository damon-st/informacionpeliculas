...
public class MovieCreditsCastAdapter extends RecyclerView.Adapter<MovieCreditsViewHolder> {
    ...
    private List<MovieCreditsCats> movieCreditsCatsList;

    public MovieCreditsCastAdapter(Activity activity, List<MovieCreditsCats> movieCreditsCatsList) {
        this.activity = activity;
        this.movieCreditsCatsList = movieCreditsCatsList;
    }
    ...
    public void onBindViewHolder(@NonNull MovieCreditsViewHolder holder, int position) {
        ...
        MovieCreditsCats movieCreditsCats =movieCreditsCatsList.get(position);

        holder.setMovieCreditsImageView(activity,movieCreditsCats.getProfile_path());

        holder.movieCreditsName.setText(movieCreditsCats.getName());
        holder.movieCreditsCharacter.setText("Personaje : "+movieCreditsCats.getCharacter());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("id",String.valueOf(movieCreditsCats.getId()));
    ...
    public int getItemCount() {
        return movieCreditsCatsList.size();
    }
}
