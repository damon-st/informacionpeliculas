...
public class ExtraTvVideosRecyclerViewAdaper extends RecyclerView.Adapter<MovieVideosViewHolder> {

    private Activity activity;
    private List<TvSeasonsVideoResults> movieVideosResultsList ;

    public ExtraTvVideosRecyclerViewAdaper(Activity activity, List<TvSeasonsVideoResults> movieVideosResultsList) {
    ...
    public void onBindViewHolder(@NonNull MovieVideosViewHolder holder, int position) {
        ...
        TvSeasonsVideoResults movieVideosResults = movieVideosResultsList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayList<TvSeasonsVideoResults> movieVideosResultsArrayList = new ArrayList<>(movieVideosResultsList);
