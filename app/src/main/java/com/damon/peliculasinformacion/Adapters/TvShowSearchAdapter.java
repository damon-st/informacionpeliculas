...
public class TvShowSearchAdapter extends RecyclerView.Adapter<SearchViewHolder> {

    private Activity activity;
    private List<TvResponseResults> tvResponseResultsList;

    public TvShowSearchAdapter(Activity activity, List<TvResponseResults> tvResponseResultsList) {
    ...
    public void onBindViewHolder(@NonNull SearchViewHolder holder, int position) {
        TvResponseResults tvResponseResults = tvResponseResultsList.get(position);
