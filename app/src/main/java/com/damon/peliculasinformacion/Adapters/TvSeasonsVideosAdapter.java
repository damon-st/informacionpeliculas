...
public class TvSeasonsVideosAdapter extends RecyclerView.Adapter<MovieVideosViewHolder> {

    private Activity activity;
    private List<TvSeasonsVideoResults> movieVideosResultsList ;

    public TvSeasonsVideosAdapter(Activity activity, List<TvSeasonsVideoResults> movieVideosResultsList) {
