...
public class MovieDetails {
    ...
    private List<MoviesDetailsSpokenLanguages> spoken_languages;
    ...
    public MovieDetails(boolean adult, String backdrop_path, MovieDetailBelongsToCollection belongs_to_collection, float budget, List<MovieDetailsGenres> genres, String homepage, Integer id, String imdb_id, String original_lenguage, String original_title, String overview, Double popularity, String poster_path, List<MovieDetailsProductionCompanies> production_companies, List<MovieDetailsProductionCountries> production_countries, String release_date, float revenue, Integer runtime, List<MoviesDetailsSpokenLanguages> spoken_languages, String status, String tagline, String title, boolean video, Double vote_average, Integer vote_count) {
        this.adult = adult;
    ...
    public List<MoviesDetailsSpokenLanguages> getSpoken_languages() {
        return spoken_languages;
    }

    public void setSpoken_languages(List<MoviesDetailsSpokenLanguages> spoken_languages) {
        this.spoken_languages = spoken_languages;
    }
